...
//____________________________draiver motor________________________________
...
//__________________________contorol pid_______________________________
  ...
  Serial.println("Output "+String(Output*myspeed)+" "+ String(Input));
    ...
    if (encoderValue >(1200-khalasi) && encoderValue<(1200+khalasi))
      Output = 0;
    if(Output > 0)
      doStep(false,(int)abs(myspeed*Output), stepdelay);
    if(Output < 0)
      doStep(true, (int)abs(myspeed*Output), stepdelay);
    }
